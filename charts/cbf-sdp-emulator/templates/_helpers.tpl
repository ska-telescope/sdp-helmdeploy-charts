...
*/}}
{{- define "cbf_sdp_emulator.fullname" -}}
...
Common labels
*/}}
{{- define "cbf_sdp_emulator.labels" -}}
app.kubernetes.io/name: {{ include "cbf_sdp_emulator.name" . }}
helm.sh/chart: {{ include "cbf_sdp_emulator.chart" . }}
